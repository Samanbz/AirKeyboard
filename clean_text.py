...
def clean_text(input_file_path, output_file_path):
    ...
    try:
        ...
        print(f"Successfully cleaned '{input_file_path}' and saved it to '{output_file_path}'")
    except Exception as e:
...
if __name__ == "__main__":
    ...
    parser.add_argument("output_file", help="The path to save the cleaned output file.")
